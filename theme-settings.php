 ...
 *   The form state.
 */
function msh_adminimal_form_system_theme_settings_alter(&$form, &$form_state) {

  // Get msh_adminimal theme path.
  global $base_url;
  ...
  $form['msh_adminimal_custom'] = array(
    '#type' => 'fieldset',
  ...
  $form['skin']['adminimal_theme_skin'] = array(
    ...
    '#default_value' => theme_get_setting('msh_adminimal_theme_skin'),
    '#options' => array(
  ...
  $form['msh_adminimal_custom']['style_checkboxes'] = array(
    '#type' => 'checkbox',
  ...
  $form['msh_adminimal_custom']['display_icons_config'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display icons in Configuration page'),
    '#default_value' => theme_get_setting('display_icons_config'),
  );

  $form['msh_adminimal_custom']['rounded_buttons'] = array(
    '#type' => 'checkbox',
  ...
  $form['msh_adminimal_custom']['sticky_actions'] = array(
    '#type' => 'checkbox',
  ...
  $form['msh_adminimal_custom']['avoid_custom_font'] = array(
    '#type' => 'checkbox',
  ...
  $form['msh_adminimal_custom']['adminimal_ckeditor'] = array(
    '#type' => 'checkbox',
  ...
  $form['msh_adminimal_custom']['use_custom_media_queries'] = array(
    '#type' => 'checkbox',
  ...
  $form['msh_adminimal_custom']['media_queries'] = array(
    '#type' => 'fieldset',
  ...
  $form['msh_adminimal_custom']['custom_css'] = array(
    '#type' => 'checkbox',
  ...
  $form['msh_adminimal_custom']['adminimal_custom_check'] = array(
    '#type' => 'fieldset',
  ...
  if (file_exists($custom_css_path)) {
    $form['msh_adminimal_custom']['adminimal_custom_check']['custom_css_description'] = array(
    ...
    $form['msh_adminimal_custom']['adminimal_custom_check']['custom_css_not_found'] = array(
